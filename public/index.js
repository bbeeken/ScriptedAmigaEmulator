...
const URL_DATABASE =
  window.location.protocol + "//" + window.location.hostname + ":3000" + "/db";
...
const DB_IDS = [
  ["cfg_game", "cfg_demo", "cfg_demo_aga", "cfg_tool"],
  [
...
const URL_LOEWENSTEIN = mkA(
  "https://www.richard-loewenstein.de",
  "Richard Löwenstein"
);
...
const db = [
  ...
  new dbEntry(
    ...
    "1993",
    0,
    "Loading takes some time, just wait."
  ),
  new dbEntry(
    DBT_GAME,
    1,
    ...
    "2012",
    0,
    "The color-stripes are normal, just wait..."
  ),
  new dbEntry(
    DBT_GAME,
    1,
    ...
    "2012",
    0,
    "After the start, click the RMB for the trainer menu. The color-stripes are normal, just wait..."
  ),
  new dbEntry(
    DBT_GAME,
    1,
  ...
  new dbEntry(
    ...
    "1991",
    DBF_ECS,
    "The blue flashing in the beginning is normal. Just wait..."
  ),
  ...
  new dbEntry(
    ...
    "1992",
    DBF_MDC | DBF_BIM,
    "Insert the 2nd disk manually and click the RMB when done."
  ),
  new dbEntry(
    DBT_DEMO,
    1,
  ...
  new dbEntry(
    ...
    "1991",
    0,
    "Press the LMB at the intro-screen."
  ),
  new dbEntry(
    DBT_DEMO,
    1,
  ...
  new dbEntry(
    DBT_DEMO,
    1,
    "Project-X (demo rolling)",
    "Team 17",
    "",
    "",
    "1992",
    0,
    "Press 'Fire' to skip to the 2nd level anytime."
  ),
  new dbEntry(
    DBT_DEMO,
    1,
  ...
  new dbEntry(
    ...
    "1996",
    DBF_AGA | DBF_030,
    "Open the disk AC1: by double-click and then double-click 'BurningChrome' <b>once</b>."
  ),
  new dbEntry(
    DBT_DAGA,
    1,
  ...
  new dbEntry(
    ...
    "",
    "1995",
    DBF_AGA | DBF_030 | DBF_MDC,
    "When asked, insert the 2nd disk manually."
  ),
  new dbEntry(
    DBT_DAGA,
    1,
  ...
  new dbEntry(
    ...
    1,
    "Not Again",
    "Sanity, Complex, Avena, Lego",
    "",
    "",
    "1992",
    DBF_AGA,
    "Press the RMB to get to the next section anytime."
  ),
  new dbEntry(
    DBT_DAGA,
    2,
  ...
  new dbEntry(
    ...
    "1994",
    DBF_AGA | DBF_NOT,
    "In the last 3d-scene, hold the LMB to rotate and the RMB to walk around. (the scene which does have graphics errors)"
  ),
  ...
  new dbEntry(
    ...
    "1996",
    DBF_MDC | DBF_AGA,
    "When asked, change the disks manually."
  ),
  ...
  new dbEntry(
    ...
    "2016",
    0,
    "Press 'Cancel' when asked for a Live-CD."
  ),
  new dbEntry(
    DBT_TOOL,
    1,
    ...
    "1993",
    0,
    "Type 'aibb' at the console. Be very patient at the 'Evaluating System...' screen."
  ),
...
const crc32Table = (function () {
  ...
  for (n = 0; n < 256; n++) {
    c = n;
    for (k = 0; k < 8; k++) c = ((c >>> 1) ^ (c & 1 ? 0xedb88320 : 0)) >>> 0;
    table[n] = c;
  }
  return table;
})();
...
if (crc32("The quick brown fox jumps over the lazy dog") != 0x414fa339)
  alert(
    "CRC32-hash testing failed. SAE will not work. This is an internal bug!?"
  );
...
function getSelect(id, asString) {
  ...
  for (var i = 0; i < e.length; i++) {
    if (e[i].selected) return asString ? e[i].value : Number(e[i].value);
  }
...
function getRadio(name, asString) {
  ...
  for (var i = 0; i < e.length; i++) {
    if (e[i].checked) return asString ? e[i].value : Number(e[i].value);
  }
...
function saee2text(err) {
  switch (err) {
    case SAEE_NotRunning:
      return "The emulator is not running.";
    case SAEE_NoTimer:
      return "No timing-functions avail. Please upgrade your browser.";
    case SAEE_NoMemory:
      return "Out of memory.";
    case SAEE_Assert:
      return "Assertiation failed.";
    case SAEE_Internal:
      return "Internal emulator error.";
    case SAEE_Config_Invalid:
      return "Invalid configuration.";
    case SAEE_Config_Compressed:
      return "A ZIP file was detected. Compressed files are not yet supported.";
    case SAEE_CPU_Internal:
      return "Internal CPU-error.";
    case SAEE_CPU_Requires68020:
      return "The selected kickstart-rom does require a 68020 and 32bit address-space";
    case SAEE_CPU_Requires680EC20:
      return "The selected kickstart-rom does require a 68020.";
    case SAEE_CPU_Requires68030:
      return "The selected kickstart-rom does require a 68030.";
    case SAEE_CPU_Requires68040:
      return "The selected kickstart-rom does require a 68040/68060.";
    case SAEE_Memory_NoKickstartRom:
      return "The kickstart-rom is missing.";
    case SAEE_Memory_NoExtendedRom:
      return "An extended-rom is required but missing.\n\nGo to the ROM-page and select a rom from disk...";
    case SAEE_Memory_RomSize:
      return "The kickstart- or extended-rom does have an invalid size.";
    case SAEE_Memory_RomKey:
      return "A ROM-keyfile is required. (Cloanto)";
    case SAEE_Memory_RomDecode:
      return "Invalid ROM-keyfile. (Cloanto)";
    case SAEE_Memory_RomChecksum:
      return "Checksum-error at the kickstart- or extended-rom.";
    case SAEE_Memory_RomUnknown:
      return "Unknown ROM.";
    case SAEE_Video_ElementNotFound:
      return "Video DIV-element not found. Check 'cfg.video.id'";
    case SAEE_Video_RequiresCanvas:
      return "This browser does not support 'Canvas'. Please upgrade to an actual version.";
    case SAEE_Video_RequiresWegGl:
      return "This browser does not support 'WebGL'. Please upgrade to an actual version.";
    case SAEE_Video_ComphileShader:
      return "Can not compile the required shader-program.";
    case SAEE_Video_LinkShader:
      return "Can not link the required shader-program.";
    case SAEE_Video_RequiresFullscreen:
      return "This browser does not support the 'Fullscreen-API'. Please upgrade to an actual version.";
    case SAEE_Audio_RequiresWebAudio:
      return "This browser does not support 'WebAudio'. Please upgrade to an actual version.";
    case SAEE_Input_GamepadNotReady:
      return "The selected joystick-/gamepad-device is not ready.\n\nTry to press some buttons after closing this window...";
    default:
      return "(" + err + ")";
  }
}
...
function dbInit() {
  function addOption(select, text, value) {
    ...
    if (text.length) option.text = text;
  ...
  for (var dbt = 1; dbt <= 4; dbt++) {
    ...
    for (var i = 0; i < db.length; i++) {
      if (db[i].type == dbt) addOption(s, db[i].name, 1 + i);
    }
  }
  for (var dbt = 1; dbt <= 4; dbt++) {
    ...
    for (var i = 0; i < db.length; i++) {
      if (db[i].type == dbt) {
        if (!(db[i].flags & DBF_MDC))
          /* skip items that require manual disk-change */
...
function dbFindTypeNamePos(type, name) {
  for (var i = 0; i < db.length; i++) {
    if (db[i].type == type && db[i].name == name) return i;
  }
  return -1;
}
...
function Cache() {
  ...
  this.req = function (path, name, size, crc, dst) {
    ...
    load(url, function () {
      if (this.status == 200) {
        ...
        alert(
          sprintf(
            "Error while downloading '%s' (http status: %d)",
            url,
            this.status
          )
        );
  ...
  this.state = function () {
    for (var i = 0; i < items.length; i++) {
      if (items[i].state != S_VALID) return items[i].state;
    }
    return S_VALID;
  };
}
...
function getDatabaseEntryFilename(dbe, disk, adf) {
  if (dbe.numdisks == 1) return dbe.name + (adf ? ".adf" : "");
  else
...
function getDatabaseFloppy() {
  if (dbNum == 0) {
    /* nothing selected */
    for (var i = 0; i < 4; i++) {
      cfg.floppy.drive[i].type =
        i == 0 ? SAEC_Config_Floppy_Type_35_DD : SAEC_Config_Floppy_Type_None;
  ...
  dskchgList = [];
  if (dbe.flags & DBF_MDC) {
    /* manual disk-change required */
    if (dbe.numdisks == 1) dskchgList.push(dbe.name);
    else {
    ...
    for (var n = 1; n < dbe.numdisks; n++) {
      cfg.floppy.drive[n].type =
        SAEC_Config_Floppy_Type_None; /* disable for now. will be enabled when a disk is inserted */
  ...
  cfg.floppy.speed =
    (dbe.flags & DBF_NOT) == 0
      ? SAEC_Config_Floppy_Speed_Turbo
      : SAEC_Config_Floppy_Speed_Original;
  return true;
}
...
function getDatabaseConfig() {
  ...
  if (dbe !== null) {
    ...
    else sae.setModel(SAEC_Model_A500, 0); /* set an A500 for OCS */

    if (dbe.flags & DBF_030) cfg.cpu.model = SAEC_Config_CPU_Model_68030;
    ...
    if (dbe.flags & DBF_COL)
      cfg.chipset.colLevel =
        SAEC_Config_Chipset_ColLevel_Sprite_Playfield; /* enable collision-detection */

    if (dbe.flags & DBF_BIM) cfg.chipset.blitter.immediate = true;
  } else {
  ...
  if (!getDatabaseFloppy()) return false;
...
function setRomName() {
  ...
  if (cfg.memory.rom.name.length) {
    if (defRomInfo !== null) {
      ...
      e.className =
        defRomInfo.type & SAEC_RomType_ALL_KICK ? "green" : "orange";
...
function setFloppyName(n) {
  ...
  if (cfg.floppy.drive[n].file.size) {
    ...
    if (cfg.floppy.drive[n].file.name.length > MAX_FILENAME)
      e.innerHTML =
        cfg.floppy.drive[n].file.name.substr(0, MAX_FILENAME) + " [...]";
    else e.innerHTML = cfg.floppy.drive[n].file.name;
...
function fixAdvandedConfig() {
  ...
  if (cfg.video.enabled) {
    if (!inf.video.canvas && !inf.video.webGL) cfg.video.enabled = false;
    else if (
    ...
    if (
      SAEV_config.video.cursor == SAEC_Config_Video_Cursor_Lock &&
      !inf.video.pointerLock
    )
...
function setAdvandedConfig() {
  ...
  if (cfg.chipset.mask & SAEC_Config_Chipset_Mask_AGA)
    ...
    cfg.chipset.mask & SAEC_Config_Chipset_Mask_ECS_AGNUS &&
    cfg.chipset.mask & SAEC_Config_Chipset_Mask_ECS_DENISE
  ) {
  ...
  } else setRadio("cfg_chipset_mask", 1);
  ...
  switch (cfg.chipset.compatible) {
    case SAEC_Config_Chipset_Compatible_Generic:
      setSelect("cfg_chipset_features", "generic");
      break;
    case SAEC_Config_Chipset_Compatible_A500:
      setSelect("cfg_chipset_features", "A500");
      break;
    case SAEC_Config_Chipset_Compatible_A500P:
      setSelect("cfg_chipset_features", "A500P");
      break;
    case SAEC_Config_Chipset_Compatible_A600:
      setSelect("cfg_chipset_features", "A600");
      break;
    case SAEC_Config_Chipset_Compatible_A1000:
      setSelect("cfg_chipset_features", "A1000");
      break;
    case SAEC_Config_Chipset_Compatible_A1000V:
      setSelect("cfg_chipset_features", "A1000V");
      break;
    case SAEC_Config_Chipset_Compatible_A1200:
      setSelect("cfg_chipset_features", "A1200");
      break;
    case SAEC_Config_Chipset_Compatible_A2000:
      setSelect("cfg_chipset_features", "A2000");
      break;
    case SAEC_Config_Chipset_Compatible_A3000:
      setSelect("cfg_chipset_features", "A3000");
      break;
    case SAEC_Config_Chipset_Compatible_A4000:
      setSelect("cfg_chipset_features", "A4000");
      break;
    ...
    case SAEC_Config_Chipset_Compatible_Manual:
      setSelect("cfg_chipset_features", "manual");
      break;
  }
  styleDisplayBlock(
    "cfg_chipset_features_grp",
    cfg.chipset.compatible == SAEC_Config_Chipset_Compatible_Manual
  );
  {
  ...
  //if (cfg.video.enabled)
  {
    ...
    setSelect(
      "cfg_video_linemode",
      cfg.video.pscanlines == 1 ? 2 : cfg.video.vresolution
    );
  ...
  styleDisplayBlock(
    "cfg_video_error_canvas",
    inf.video.canvas == false && inf.video.webGL == false
  );
  ...
  styleDisplayInline(
    "cfg_ports_0_joyemu_grp",
    cfg.ports[0].type == SAEC_Config_Ports_Type_JoyEmu
  );
  styleDisplayInline(
    "cfg_ports_0_joy_grp",
    cfg.ports[0].type == SAEC_Config_Ports_Type_Joy
  );
  ...
  styleDisplayInline(
    "cfg_ports_1_joyemu_grp",
    cfg.ports[1].type == SAEC_Config_Ports_Type_JoyEmu
  );
  styleDisplayInline(
    "cfg_ports_1_joy_grp",
    cfg.ports[1].type == SAEC_Config_Ports_Type_Joy
  );
  ...
  for (var n = 0; n < 6; n++) {
    ...
    if (getCheckbox("cfg_mount_" + n + "_enabled")) {
      if (n < 4) {
        ...
        ci.controller_media_type = getSelect(
          "cfg_mount_" + n + "_controller_media"
        );
        ci.unit_feature_level = getSelect(
          "cfg_mount_" + n + "_controller_level"
        );
      } else if (n == 4)
        ci.controller_type = SAEC_Config_Mount_Controller_Type_PCMCIA_SRAM;
      else ci.controller_type = SAEC_Config_Mount_Controller_Type_PCMCIA_IDE;
      if (n != 5) ci.readonly = getCheckbox("cfg_mount_" + n + "_readonly");
    } else ci.controller_type = 0;
  }
}
function getAdvandedConfig() {
  ...
  cfg.cpu.addressSpace24 = getCheckbox("cfg_cpu_address_space_32")
    ? false
    : true;
  ...
  switch (getRadio("cfg_chipset_mask")) {
    ...
    case 2: {
      switch (getSelect("cfg_chipset_mask_ecs")) {
        ...
        case 3:
          cfg.chipset.mask |=
            SAEC_Config_Chipset_Mask_ECS_AGNUS |
            SAEC_Config_Chipset_Mask_ECS_DENISE;
          break;
      }
      break;
    }
  ...
  switch (getSelect("cfg_chipset_features", true)) {
    case "generic":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_Generic;
      break;
    case "A500":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_A500;
      break;
    case "A500P":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_A500P;
      break;
    case "A600":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_A600;
      break;
    case "A1000":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_A1000;
      break;
    case "A1000V":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_A1000V;
      break;
    case "A1200":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_A1200;
      break;
    case "A2000":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_A2000;
      break;
    case "A3000":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_A3000;
      break;
    case "A4000":
      cfg.chipset.compatible = SAEC_Config_Chipset_Compatible_A4000;
      break;
  ...
  if (cfg.video.enabled) {
    ...
    cfg.video.backgroundColor = Number(
      "0x" + getText("cfg_video_background", true)
    );
    ...
    cfg.video.size_win.width =
      SAEC_Video_DEF_AMIGA_WIDTH << cfg.video.hresolution;
    cfg.video.size_win.height =
      SAEC_Video_DEF_AMIGA_HEIGHT << cfg.video.vresolution;
  }

  /* audio */
  if (getCheckbox("cfg_audio_enabled"))
    cfg.audio.mode = getSelect("cfg_audio_mode");
  else cfg.audio.mode = SAEC_Config_Audio_Mode_Off;
  ...
  if (cfg.ports[0].type == SAEC_Config_Ports_Type_JoyEmu) {
    ...
    if (
      cfg.ports[0].fire[0] != SAEC_Config_Ports_Fire_None &&
      cfg.ports[0].fire[0] == cfg.ports[0].fire[1]
    ) {
  ...
  if (cfg.ports[1].type == SAEC_Config_Ports_Type_JoyEmu) {
    ...
    if (
      cfg.ports[1].fire[0] != SAEC_Config_Ports_Fire_None &&
      cfg.ports[1].fire[0] == cfg.ports[1].fire[1]
    ) {
  ...
  if (cfg.ports[1].type == SAEC_Config_Ports_Type_Joy) {
    ...
    if (
      cfg.ports[0].type == SAEC_Config_Ports_Type_Joy &&
      cfg.ports[1].device == cfg.ports[0].device
    ) {
...
function switchCfg(m) {
  if (m == MODE_Database) {
    if (mode == MODE_Advanced) {
      if (
        !confirm(
          "Going back to the database will reset the current configuration.\n\nAre you sure?"
        )
      )
        return;
    } else {
      alert(
        "Click this logo in the advanced-config, if you want to return here."
      );
      return;
    }
  }
  ...
  if (m == MODE_Database) {
    if (page == PID_Floppy_Info && floppyNum != -1) floppyCloseInfo();
    else if (page == PID_Mount_Setup && mountConfigNum != -1)
      mountCloseSetup(false);

    setDatabaseConfig();
    changePage(PID_None);
  } /*if (m == MODE_Advanced)*/ else {
    preSelect(0);

    setAdvandedConfig();
    if (page == PID_None) changePage(PID_Model);
  }
}
...
function preSelect(grp) {
  ...
  if (dbNum == 0) /* no entry selected */ return;
  ...
  var nameLink =
    dbe.name + ' (<a target="_blank" href="' + href + '">share</a>)';
  ...
  insertRow4(
    table,
    ["Name", nameLink],
    dbe.license.length ? ["License", license] : false
  );
  insertRow4(
    table,
    ["Developer", dbe.developer],
    dbe.publisher.length ? ["Publisher", dbe.publisher] : false
  );
  insertRow2(table, ["Year", dbe.year]);
  if (grp == DBT_GAME) insertRow2(table, ["Controls", ctrl]);
  if (dbe.notes.length) insertRow2(table, ["Notes", dbe.notes]);
...
function getPageElementID(pid) {
  switch (pid) {
    case PID_Model:
      return "cfg_page_model";
    case PID_CPU:
      return "cfg_page_cpu";
    case PID_Chipset:
      return "cfg_page_chipset";
    case PID_RAM:
      return "cfg_page_ram";
    case PID_ROM:
      return "cfg_page_rom";
    case PID_ROM_Info:
      return "cfg_page_rom_info";
    case PID_Floppy:
      return "cfg_page_floppy";
    case PID_Floppy_Info:
      return "cfg_page_floppy_info";
    case PID_Mount:
      return "cfg_page_mount";
    case PID_Mount_Setup:
      return "cfg_page_mount_setup";
    case PID_Video:
      return "cfg_page_video";
    case PID_Audio:
      return "cfg_page_audio";
    case PID_Ports:
      return "cfg_page_ports";
  }
}
function changePage(pid) {
  if (page != PID_None && page == pid) return;
  if (page != PID_None) {
    if (page == PID_ROM_Info && romNum != -1) closeRomInfo();
    else if (page == PID_Floppy_Info && floppyNum != -1) floppyCloseInfo();
    else if (page == PID_Mount_Setup && mountConfigNum != -1)
      mountCloseSetup(false);
...
function selectModel() {
  ...
  if (v === false) alert("Please select a model.");
  else {
    var model,
      modelConfig = 0;
    ...
    switch (v) {
      case "A500":
        ...
        modelConfig = getSelect("cfg_model_a500");
        break;
      case "A500P":
      ...
      case "A600":
        ...
        modelConfig = getSelect("cfg_model_a600");
        break;
      case "A1000":
        model = SAEC_Model_A1000;
        modelConfig = getSelect("cfg_model_a1000");
        break;
      case "A1200":
        model = SAEC_Model_A1200;
        modelConfig = getSelect("cfg_model_a1200");
        break;
      case "A2000":
...
function immediateUpdate(imm) {
  ...
  } else setDisabled("cfg_blitter_waiting", false);
}
...
function getRomType(ri) {
  ...
  if (ri.type & SAEC_RomType_ALL_KICK) type = "Kickstart";
  else if (ri.type & SAEC_RomType_ALL_EXT) type = "Extended";
  else if (ri.type & SAEC_RomType_ALL_CART) type = "Cartridge";
  else if (ri.type & SAEC_RomType_KEY) type = "Keyfile";
  else if (ri.type & SAEC_RomType_AMAX) type = "Macintosh";
...
function openRomInfo(ri) {
  ...
  if (isKey) {
    ...
    if (ri.cpu == 68020 && ri.addressSpace24) cpu = "68EC020";
    else if (ri.cpu == 68000) cpu = "All";
    else {
      if (ri.cpuExact) cpu += " only";
      else cpu += " minimum";
      if (!ri.addressSpace24) cpu += " / 32bit";
    }
    //setText2("cfg_rom_info_name", ri.name);
    ...
    if (ri.checksum !== false)
      setText2(
        "cfg_rom_info_checksum",
        sprintf(
          "%08X (%s)",
          ri.checksum,
          ri.checksumValid ? span("green", "valid") : span("orange", "invalid")
        )
      );
    else setText2("cfg_rom_info_checksum", span("gray", NA));

    if (ri.type & SAEC_RomType_AMAX)
      setText2(
        "cfg_rom_info_version",
        sprintf("%03x %04x %04x", ri.ver, ri.rev, ri.subVer)
      );
    else if (ri.type & SAEC_RomType_ALL_KICK)
      setText2(
        "cfg_rom_info_version",
        sprintf(
          "%d.%d (exec.library %d.%d)",
          ri.ver,
          ri.rev,
          ri.subVer,
          ri.subRev
      ...
      setText2(
        "cfg_rom_info_version",
        sprintf("%d.%d (%d.%d)", ri.ver, ri.rev, ri.subVer, ri.subRev)
      );

    setText2(
      "cfg_rom_info_encrytion",
      ri.cloanto ? "Cloanto" : span("gray", NONE)
    );
    ...
    setText2(
      "cfg_rom_info_partnumber",
      ri.partNumber.length ? ri.partNumber : span("gray", NA)
    );
  }
  romNum = 0;
    ...
    loadFile(e, function (event) {
      ...
      if (err == SAEE_None) {
        ...
        if (!(defRomInfo.type & SAEC_RomType_ALL_KICK))
          alert(
            "A 'Kickstart'-ROM is required, but you selected a/an '" +
              getRomType(defRomInfo) +
              "'-ROM."
          );
      } else {
        defRomInfo = null;
        if (err != SAEE_Memory_RomUnknown) {
          if (err == SAEE_Memory_RomKey || err == SAEE_Memory_RomDecode) {
            ...
            setKeyName();
            if (err == SAEE_Memory_RomDecode) alert(saee2text(err));
          }
        }
      }
      setRomName();
...
function romOpenInfo() {
  if (defRomInfo !== null) openRomInfo(defRomInfo);
}
    ...
    loadFile(e, function (event) {
      ...
      if (err == SAEE_None) {
        ...
        if (!(extRomInfo.type & SAEC_RomType_ALL_EXT))
          alert(
            "A 'Extended'-ROM is required, but you selected a/an '" +
              getRomType(extRomInfo) +
              "'-ROM."
          );
      } else {
        extRomInfo = null;
...
function extOpenInfo() {
  if (extRomInfo !== null) openRomInfo(extRomInfo);
}
...
function keySelect() {
  ...
  if (e) {
    loadFile(e, function (event) {
      ...
      if (err != SAEE_None) romKeyInfo = null;
      ...
      if (cfg.memory.rom.size && defRomEncrypted) {
        ...
        if (err != SAEE_None) {
          defRomInfo = null;
          if (err != SAEE_Memory_RomUnknown) alert(saee2text(err));
        }
        setRomName();
      }
...
function keyOpenInfo() {
  if (romKeyInfo !== null) openRomInfo(romKeyInfo);
}
    ...
    loadFile(e, function (event) {
      ...
      if (err == SAEE_None) {
        if (!(amaxInfo.type & SAEC_RomType_AMAX))
          alert(
            "A 'Macintosh'-ROM is required, but you selected a/an '" +
              getRomType(amaxInfo) +
              "'-ROM."
          );
      } else amaxInfo = null;
...
function amaxOpenInfo() {
  if (amaxInfo !== null) openRomInfo(amaxInfo);
}
...
function floppyWaitSelect() {
  ...
  if (s == S_VALID) {
    /* all files are downloaded or cached, go! */
    for (var n = 0; n < 4; n++) {
      if (floppyIsUsed(n)) setFloppyName(n);
    }
    freezeButtons(false, false);
  } else if (s == S_PENDING) {
    /* files are still downloading, wait... */
...
function floppySelect(grp) {
  ...
  for (var n = 0; n < 4; n++) {
    if (floppyIsUsed(n)) floppyEject(n);
  }
...
function floppyOpenInfo(n) {
  ...
  setText2(
    "cfg_floppy_info_label",
    di.diskname.length ? di.diskname : span("gray", NA)
  );
  setText2(
    "cfg_floppy_info_size",
    sprintf("%d (%dK)", file.size, file.size >> 10)
  );
  setText2(
    "cfg_floppy_info_disktype",
    di.hd ? "High Density (HD)" : "Double Density (DD)"
  );

  if (di.bootblockChecksum !== false && di.bootblockChecksum !== 0)
    setText2(
      "cfg_floppy_info_checksum",
      sprintf(
        "%08X (%s)",
        di.bootblockChecksum,
        di.bootblockChecksumValid
          ? span("green", "valid")
          : span("orange", "invalid")
      )
    );
  else setText2("cfg_floppy_info_checksum", span("gray", NA));

  setText2(
    "cfg_floppy_info_boottype",
    di.bootblockType == 0
      ? "Custom"
      : di.bootblockType == 1
      ? span("green", "Standard 1.x")
      : span("green", "Standard 2.x+")
  );
  ...
  for (j = 0; j < 42; j++) {
    ...
    for (i = 0; i < 24; i++) {
      var chr = di.bootblock[j * 24 + i];
      if (chr >= 32 && chr <= 126) bb += String.fromCharCode(chr);
      else bb += ".";
    }
    bb += "\n";
  }
  ...
  if (inf.browser.id != SAEC_Info_Brower_ID_Chrome)
    document.getElementById("cfg_floppy_info_bootblock").style.fontSize =
      "12px";
...
function floppyCreate(mode) {
  ...
  name +=
    type == SAEC_Disk_Create_Type_35_DD_PC ||
  ...
  if (e) {
    loadFile(e, function (event) {
      ...
      if (
        ...
        alert(
          "The selected hard-file is too large for a PCMCIA SRAM-card. (4096K maximum)"
        );
        ok = false;
      }
      if (ok) {
        ...
        setMountName(n);
      } else document.getElementById("cfg_mount_" + n + "_file").value = "";
    });
  }
}
...
function mountCloseSetup(use) {
  if (use) {
    ...
    if (blocksize < 512 || blocksize > 65536 || (blocksize & 511) != 0) {
      alert(
        "'Blocksize' must be smaller or equal 65536 and a multiple of 512."
      );
...
function videoUpdateLineMode() {
  setDisabled(
    "cfg_video_interlace",
    getSelect("cfg_video_linemode") == SAEC_Config_Video_VResolution_NonDouble
  );
}
...
function portUpdate(n) {
  ...
  if (n == 0) {
    styleDisplayInline(
      "cfg_ports_0_joyemu_grp",
      v == SAEC_Config_Ports_Type_JoyEmu
    );
...
function hook_event_stopped() {
  ...
  if (dskchg) dskchgClose();

  if (mode == MODE_Advanced) setAdvandedConfig();
...
function hook_led_df(unit, dis, cyl, side, rw) {
  if (dis) {
    ...
    e_led_df[unit].style.color =
      rw == 1 ? COL_GREEN : rw == 2 ? COL_RED : COL_GRAY;
  }
}
...
function hook_led_cpu(usage, paused) {
  if (paused) {
    ...
    if (usage < 90) e_led_cpu.style.color = COL_GREEN;
    else if (usage < 110) e_led_cpu.style.color = COL_ORANGE;
    else e_led_cpu.style.color = COL_RED;
  }
}
...
function dskchgOpen() {
  if (!dskchg) {
    ...
    } else styleDisplayBlock("dskchg_advanced", 1);
...
function dskchgClose() {
  if (dskchg) {
    if (mode == MODE_Database) {
      ...
      var s = document.getElementById("dskchg_select");
      for (var i = s.length - 1; i > 0; i--) s.remove(i);
    } else styleDisplayBlock("dskchg_advanced", 0);
  ...
  if (inf.input.gamepad) {
    ...
    window.addEventListener("gamepaddisconnected", function (e) {
      window.setTimeout(function () {
        ...
        SAEF_info(
          "sae.initGamepads() device '" + e.gamepad.id + "' disconnected."
        );
      }, 100);
    });
  } else {
